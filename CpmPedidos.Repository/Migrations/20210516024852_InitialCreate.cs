    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tb_promocaoproduto", x => x.id);
                    table.ForeignKey(
                        name: "FK_tb_promocaoproduto_tb_imagem_id_imagem",
                        column: x => x.id_imagem,
                        principalTable: "tb_imagem",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_tb_promocaoproduto_tb_produto_id_produto",
                        column: x => x.id_produto,
                        principalTable: "tb_produto",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tb_produtopedido", x => x.id);
                    table.ForeignKey(
                        name: "FK_tb_produtopedido_tb_pedido_id_pedido",
                        column: x => x.id_pedido,
                        principalTable: "tb_pedido",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_tb_produtopedido_tb_produto_id_produto",
                        column: x => x.id_produto,
                        principalTable: "tb_produto",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tb_produtopedido_id_pedido",
                table: "tb_produtopedido",
                column: "id_pedido");

            migrationBuilder.CreateIndex(
                name: "IX_tb_produtopedido_id_produto",
                table: "tb_produtopedido",
                column: "id_produto");

            migrationBuilder.CreateIndex(
                name: "IX_tb_promocaoproduto_id_imagem",
                table: "tb_promocaoproduto",
                column: "id_imagem");

            migrationBuilder.CreateIndex(
                name: "IX_tb_promocaoproduto_id_produto",
                table: "tb_promocaoproduto",
                column: "id_produto");
        }
